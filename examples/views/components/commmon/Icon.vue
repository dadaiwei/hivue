<template>
  <div class="content-box">
    ...
    <v-anchor>
      <v-anchor-link href="icon-use" title="使用方法" />
      <v-anchor-link href="icon-ofen" title="常用图标" />
      <v-anchor-link href="icon-list" title="图标集合" />
    </v-anchor>
    <div class="demo-tip">
      <p>该项目使用 Ant Design 官方图标库</p>
      <p>
        <a
          href="https://www.iconfont.cn/collections/detail?spm=a313x.7781069.1998910419.d9df05512&cid=9402"
          target="_blank"
        >https://www.iconfont.cn/collections/detail?spm=a313x.7781069.1998910419.d9df05512&cid=9402</a>
      </p>
    </div>
    <!-- 使用方法 -->
    <div id="icon-use" class="icon-demo-container">
      <v-demo-block
        :height="210"
      ...
      >
        ...
        <template v-slot:code>
          <code class="html">{{fCode(simple.code)}}</code>
        </template>
      </v-demo-block>
    </div>
    <!-- 常用图标 -->
    <div id="icon-ofen" class="icon-list-container">
      <h3 class="demo-table-title">常用图标</h3>
      <ul class="icon-list">
        <li
          :class="{'rigth-block':index % 5 === 4}"
          :key="item"
          v-for="(item,index) in ofenIconList"
        >
          <div>
    ...
    <!-- 图标集合 -->
    <div id="icon-list" class="icon-list-container">
      <h3 class="demo-table-title">图标集合</h3>
      <ul class="icon-list">
        <li :class="{'rigth-block':index % 5 === 4}" :key="item" v-for="(item,index) in iconList">
          <div>
            <i :class="['iconfont', item]"></i>
            <p class="icon-name">{{item}}</p>
          </div>
